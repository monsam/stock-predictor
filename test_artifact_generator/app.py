...
def upload_files():
    ...
    try:
        ...
        test_cases = generate_test_cases_with_ai(requirements_text, ux_mockups_text, templates_text)
        test_plan = generate_test_plan_with_ai(requirements_text, test_cases)
        ...
        test_report = generate_test_report_with_ai(test_cases, test_results)
